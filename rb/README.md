...
The Ruby SDK for the CheckEMailOrUsernameForADataBreach API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.CheckEMailOrUsernameForADataBreach(nil).load(
  { "id" => "test01" }, nil
)
