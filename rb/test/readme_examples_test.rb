...
#      offline in seeded test mode (CheckEMailOrUsernameForADataBreachSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CheckEMailOrUsernameForADataBreach_sdk.rb")
  SDK_CLASS = "CheckEMailOrUsernameForADataBreachSDK"
  ...
  SDK_BASE = "CheckEMailOrUsernameForADataBreach_sdk"
