# CheckEMailOrUsernameForADataBreach SDK — README + REFERENCE example snippet tests.
#
...
#      (CheckEMailOrUsernameForADataBreachSDK.test) seeded with an in-memory fixture for every
