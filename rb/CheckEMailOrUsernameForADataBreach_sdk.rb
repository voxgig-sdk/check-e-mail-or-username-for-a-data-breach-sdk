...
require_relative 'CheckEMailOrUsernameForADataBreach_types'
...
class CheckEMailOrUsernameForADataBreachSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = CheckEMailOrUsernameForADataBreachHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = CheckEMailOrUsernameForADataBreachHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, CheckEMailOrUsernameForADataBreachFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    CheckEMailOrUsernameForADataBreachUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = CheckEMailOrUsernameForADataBreachHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = CheckEMailOrUsernameForADataBreachHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = CheckEMailOrUsernameForADataBreachHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => CheckEMailOrUsernameForADataBreachError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue CheckEMailOrUsernameForADataBreachError => err
    ...
    if fetched.is_a?(Hash)
      status = CheckEMailOrUsernameForADataBreachHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = CheckEMailOrUsernameForADataBreachError.new(
        "graphql_error", "CheckEMailOrUsernameForADataBreachSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = CheckEMailOrUsernameForADataBreachSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
