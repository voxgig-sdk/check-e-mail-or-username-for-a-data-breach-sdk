# CheckEMailOrUsernameForADataBreach Ruby SDK Reference

Complete API reference for the CheckEMailOrUsernameForADataBreach Ruby SDK.
...
#### `CheckEMailOrUsernameForADataBreachSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.DataBreachCheck.list(nil)
```
