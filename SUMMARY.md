...
| --- | --- | --- | --- |
| DataBreachCheck | `list` | `GET /public` | See reference |

## Connect to the API

- Production server: `https://leakcheck.io/api`
...
- `check-e-mail-or-username-for-a-data-breach_list`: List records for an entity. Supported entities: `data_breach_check`.
- `check-e-mail-or-username-for-a-data-breach_load`: Load one record for an entity. No active entity supports this operation.
