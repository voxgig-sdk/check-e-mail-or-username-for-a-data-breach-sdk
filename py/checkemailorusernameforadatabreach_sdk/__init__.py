...
from checkemailorusernameforadatabreach_sdk.utility import register

# Load features
from checkemailorusernameforadatabreach_sdk.feature.base_feature import CheckEMailOrUsernameForADataBreachBaseFeature
from checkemailorusernameforadatabreach_sdk.features import _has_feature, _make_feature
...
class CheckEMailOrUsernameForADataBreachSDK:
    ...
    def get_utility(self):
        return CheckEMailOrUsernameForADataBreachUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CheckEMailOrUsernameForADataBreachSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DataBreachCheck(self, data=None) -> "DataBreachCheckEntity":
        ...
        from checkemailorusernameforadatabreach_sdk.entity.data_breach_check_entity import DataBreachCheckEntity
