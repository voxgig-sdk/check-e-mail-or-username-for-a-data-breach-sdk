...
from checkemailorusernameforadatabreach_sdk.core.helpers import get_ctx_prop, to_map
...
class CheckEMailOrUsernameForADataBreachContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CheckEMailOrUsernameForADataBreachControl()
        ...
        if isinstance(sp, CheckEMailOrUsernameForADataBreachSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CheckEMailOrUsernameForADataBreachResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CheckEMailOrUsernameForADataBreachResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CheckEMailOrUsernameForADataBreachOperation({})
        ...
        op = CheckEMailOrUsernameForADataBreachOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return CheckEMailOrUsernameForADataBreachError(code, msg, self)
