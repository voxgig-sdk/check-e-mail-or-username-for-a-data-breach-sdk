...
from checkemailorusernameforadatabreach_sdk.checkemailorusernameforadatabreach_types import (
    DataBreachCheck,
...
class DataBreachCheckEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataBreachCheckEntity(self._client, opts)
    ...
    def data_get(self) -> DataBreachCheck:
    ...
    def match_get(self) -> DataBreachCheck:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DataBreachCheck]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DataBreachCheck().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
