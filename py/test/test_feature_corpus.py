...
def _client(kase):
    ...
    CheckEMailOrUsernameForADataBreachSDK(...), not CheckEMailOrUsernameForADataBreachSDK.test(...): the `test` feature is
    ...
    return CheckEMailOrUsernameForADataBreachSDK(opts)
