# CheckEMailOrUsernameForADataBreach SDK — documentation python-examples test.
#
...
def test_reference_python_blocks_compile():
    ...
    # module name must match the real checkemailorusernameforadatabreach_sdk.py file.
