# CheckEMailOrUsernameForADataBreach SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CheckEMailOrUsernameForADataBreachSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CheckEMailOrUsernameForADataBreachSDK(...) and CheckEMailOrUsernameForADataBreachSDK.test(...) become
#      CheckEMailOrUsernameForADataBreachSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "checkemailorusernameforadatabreach_sdk"
_SDK_CLASS = "CheckEMailOrUsernameForADataBreachSDK"
...
_ENTITIES = {
    "DataBreachCheck": "data_breach_check",
}
