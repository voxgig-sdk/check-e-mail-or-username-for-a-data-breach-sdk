...
class CheckEMailOrUsernameForADataBreachFeatures
{
    public static function make_feature(string $name)
    {
        switch ($name) {
            ...
            case "ratelimit":
                return new CheckEMailOrUsernameForADataBreachRatelimitFeature();
            case "retry":
                return new CheckEMailOrUsernameForADataBreachRetryFeature();
            case "test":
                return new CheckEMailOrUsernameForADataBreachTestFeature();
            case "timeout":
                return new CheckEMailOrUsernameForADataBreachTimeoutFeature();
            default:
                return new CheckEMailOrUsernameForADataBreachBaseFeature();
        }
    }
