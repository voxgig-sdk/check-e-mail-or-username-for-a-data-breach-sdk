...
// CheckEMailOrUsernameForADataBreach SDK timeout feature
...
class CheckEMailOrUsernameForADataBreachTimeoutFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _with_timeout(CheckEMailOrUsernameForADataBreachContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CheckEMailOrUsernameForADataBreachContext $_ctx, float $ms): void
    {
        $client = $this->client;
