...
// CheckEMailOrUsernameForADataBreach SDK cache feature
...
class CheckEMailOrUsernameForADataBreachCacheFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _through(CheckEMailOrUsernameForADataBreachContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
