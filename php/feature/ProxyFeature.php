...
// CheckEMailOrUsernameForADataBreach SDK proxy feature
...
class CheckEMailOrUsernameForADataBreachProxyFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    public function init(CheckEMailOrUsernameForADataBreachContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CheckEMailOrUsernameForADataBreachContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
