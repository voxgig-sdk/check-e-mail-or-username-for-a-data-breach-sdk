...
// CheckEMailOrUsernameForADataBreach SDK ratelimit feature
...
class CheckEMailOrUsernameForADataBreachRatelimitFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _acquire(CheckEMailOrUsernameForADataBreachContext $ctx): void
    {
    ...
    private function _track(CheckEMailOrUsernameForADataBreachContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
