...
// CheckEMailOrUsernameForADataBreach SDK audit feature
...
class CheckEMailOrUsernameForADataBreachAuditFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _emit(CheckEMailOrUsernameForADataBreachContext $ctx, string $outcome): void
    {
