...
// CheckEMailOrUsernameForADataBreach SDK pipeline test
//
...
{
    private static function utility(): CheckEMailOrUsernameForADataBreachUtility
    {
        return new CheckEMailOrUsernameForADataBreachUtility();
    }
    ...
    private static function ctx(array $over = []): CheckEMailOrUsernameForADataBreachContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CheckEMailOrUsernameForADataBreachContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CheckEMailOrUsernameForADataBreachError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CheckEMailOrUsernameForADataBreachMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CheckEMailOrUsernameForADataBreachMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CheckEMailOrUsernameForADataBreachMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CheckEMailOrUsernameForADataBreachSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CheckEMailOrUsernameForADataBreachMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CheckEMailOrUsernameForADataBreachResponse([]),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec([]),
            'response' => null,
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's']),
            'response' => new CheckEMailOrUsernameForADataBreachResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's']),
            'response' => new CheckEMailOrUsernameForADataBreachResponse(self::resp(200, ['v' => 1])),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's']),
            'response' => new CheckEMailOrUsernameForADataBreachResponse(self::resp(200, ['v' => 2])),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
    ...
    {
        $preset = new CheckEMailOrUsernameForADataBreachResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec([]),
            'response' => new CheckEMailOrUsernameForADataBreachResponse([]),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ...
        [$got, $err] = CheckEMailOrUsernameForADataBreachMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CheckEMailOrUsernameForADataBreachResult([])]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CheckEMailOrUsernameForADataBreachSpec([]), 'result' => null]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's']),
            'result' => new CheckEMailOrUsernameForADataBreachResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CheckEMailOrUsernameForADataBreachMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's']),
            'result' => new CheckEMailOrUsernameForADataBreachResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CheckEMailOrUsernameForADataBreachOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CheckEMailOrUsernameForADataBreachMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CheckEMailOrUsernameForADataBreachResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CheckEMailOrUsernameForADataBreachSpec([]),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CheckEMailOrUsernameForADataBreachMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CheckEMailOrUsernameForADataBreachError('boom', 'boom');
        $utility->fetcher = function (CheckEMailOrUsernameForADataBreachContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CheckEMailOrUsernameForADataBreachContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CheckEMailOrUsernameForADataBreachResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CheckEMailOrUsernameForADataBreachContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CheckEMailOrUsernameForADataBreachSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CheckEMailOrUsernameForADataBreachResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CheckEMailOrUsernameForADataBreachSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CheckEMailOrUsernameForADataBreachMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CheckEMailOrUsernameForADataBreachMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CheckEMailOrUsernameForADataBreachMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CheckEMailOrUsernameForADataBreachResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CheckEMailOrUsernameForADataBreachDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CheckEMailOrUsernameForADataBreachResult(['ok' => false])]);
        $this->expectException(CheckEMailOrUsernameForADataBreachError::class);
        CheckEMailOrUsernameForADataBreachDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CheckEMailOrUsernameForADataBreachResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CheckEMailOrUsernameForADataBreachMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CheckEMailOrUsernameForADataBreachMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CheckEMailOrUsernameForADataBreachBaseFeature();
        $b = new CheckEMailOrUsernameForADataBreachBaseFeature();
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $a);
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CheckEMailOrUsernameForADataBreachBaseFeature
    {
        $f = new CheckEMailOrUsernameForADataBreachBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, self::named_feature('a'));
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $replace);
        ...
        CheckEMailOrUsernameForADataBreachFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CheckEMailOrUsernameForADataBreachContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CheckEMailOrUsernameForADataBreachSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CheckEMailOrUsernameForADataBreachPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CheckEMailOrUsernameForADataBreachPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CheckEMailOrUsernameForADataBreachResponse(['headers' => null]),
            'result' => new CheckEMailOrUsernameForADataBreachResult([]),
        ]);
        CheckEMailOrUsernameForADataBreachResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CheckEMailOrUsernameForADataBreachResultBody::call($ctx);
