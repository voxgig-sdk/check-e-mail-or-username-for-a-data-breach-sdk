...
// CheckEMailOrUsernameForADataBreach SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CheckEMailOrUsernameForADataBreachOmni::makeStructRunner(
    ...
    {
        return CheckEMailOrUsernameForADataBreachOmni::objmodel(CheckEMailOrUsernameForADataBreachOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return CheckEMailOrUsernameForADataBreachOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return CheckEMailOrUsernameForADataBreachOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CheckEMailOrUsernameForADataBreachOmni::structfix($now, Struct::undef()))
                        !== json_encode(CheckEMailOrUsernameForADataBreachOmni::structfix($val, Struct::undef()))) {
