...
// CheckEMailOrUsernameForADataBreach SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CheckEMailOrUsernameForADataBreachSDK::test)
...
{
    private const SDK_CLASS = 'CheckEMailOrUsernameForADataBreachSDK';
    ...
    private const SDK_BASE = 'checkemailorusernameforadatabreach_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../checkemailorusernameforadatabreach_sdk.php';
