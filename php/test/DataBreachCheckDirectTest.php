...
class DataBreachCheckDirectTest extends TestCase
{
    public function test_direct_list_data_breach_check(): void
    {
        $setup = data_breach_check_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-data_breach_check", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
