...
class DataBreachCheckEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = CheckEMailOrUsernameForADataBreachSDK::test($seed, null);
        $seen = iterator_to_array($base->DataBreachCheck(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->DataBreachCheck(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHECK_E_MAIL_OR_USERNAME_FOR_A_DATA_BREACH_TEST_DATA_BREACH_CHECK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function data_breach_check_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHECK_E_MAIL_OR_USERNAME_FOR_A_DATA_BREACH_TEST_DATA_BREACH_CHECK_ENTID");
