...
type Args struct {
	Entity string         `json:"entity" jsonschema:"data_breach_check"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CheckEMailOrUsernameForADataBreachSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "check-e-mail-or-username-for-a-data-breach_list",
		Description: "List records from CheckEMailOrUsernameForADataBreach. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "check-e-mail-or-username-for-a-data-breach_load",
		Description: "Load a single record from CheckEMailOrUsernameForADataBreach. " +
...
func runOp(client *sdk.CheckEMailOrUsernameForADataBreachSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CheckEMailOrUsernameForADataBreachSDK, name string) (sdk.CheckEMailOrUsernameForADataBreachEntity, error) {
	switch strings.ToLower(name) {
	case "data_breach_check":
		return client.DataBreachCheck(nil), nil
