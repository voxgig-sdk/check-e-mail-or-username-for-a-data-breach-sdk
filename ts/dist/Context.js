...
const CheckEMailOrUsernameForADataBreachError_1 = require("./CheckEMailOrUsernameForADataBreachError");
...
class Context {
    ...
    error(code, msg) {
        return new CheckEMailOrUsernameForADataBreachError_1.CheckEMailOrUsernameForADataBreachError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
