...
class DataBreachCheckEntity extends CheckEMailOrUsernameForADataBreachEntityBase_1.CheckEMailOrUsernameForADataBreachEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'data_breach_check';
        this.name_ = 'data_breach_check';
        this.Name = 'DataBreachCheck';
    }
    make() {
        return new DataBreachCheckEntity(this._client, this.entopts());
    }
...
exports.DataBreachCheckEntity = DataBreachCheckEntity;
//# sourceMappingURL=DataBreachCheckEntity.js.map