...
(0, node_test_1.describe)('DataBreachCheckDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CheckEMailOrUsernameForADataBreachSDK({
    ...
    (0, node_test_1.test)('direct-list-data_breach_check', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-data_breach_check', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CHECK_E_MAIL_OR_USERNAME_FOR_A_DATA_BREACH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CheckEMailOrUsernameForADataBreachSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CHECK_E_MAIL_OR_USERNAME_FOR_A_DATA_BREACH_TEST_DATA_BREACH_CHECK_ENTID'];
    ...
    const client = new __1.CheckEMailOrUsernameForADataBreachSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DataBreachCheckDirect.test.js.map