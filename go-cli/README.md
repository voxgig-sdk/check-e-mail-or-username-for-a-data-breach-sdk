# check-e-mail-or-username-for-a-data-breach-cli

boru-driven command-line client **and** interactive REPL for the CheckEMailOrUsernameForADataBreach
...
```sh
# 1. Build a native binary (-> dist/<os>-<arch>/check-e-mail-or-username-for-a-data-breach-cli)
make build

# 2. See usage (words, entities, env vars)
./check-e-mail-or-username-for-a-data-breach-cli --help
...
./check-e-mail-or-username-for-a-data-breach-cli list data_breach_check

# 5. Override the API base URL for a single call
CHECK_E_MAIL_OR_USERNAME_FOR_A_DATA_BREACH_BASE=https://api.example.com ./check-e-mail-or-username-for-a-data-breach-cli list data_breach_check

# 6. No arguments -> interactive REPL
./check-e-mail-or-username-for-a-data-breach-cli
check-e-mail-or-username-for-a-data-breach> list data_breach_check
check-e-mail-or-username-for-a-data-breach> /quit
```
...
1. **Build the binary.** From this `go-cli/` directory:
   ...
   ```sh
   make build          # -> dist/<os>-<arch>/check-e-mail-or-username-for-a-data-breach-cli
   ```
...
3. **Run a query.** Evaluate an boru expression against the API (or run with no
   ...
   ```sh
   ./dist/*/check-e-mail-or-username-for-a-data-breach-cli list data_breach_check
   ```
...
Run with no arguments to open a REPL (prompt `check-e-mail-or-username-for-a-data-breach>`). Each line is
evaluated as its own boru expression:

```text
$ ./check-e-mail-or-username-for-a-data-breach-cli
check-e-mail-or-username-for-a-data-breach> list data_breach_check
check-e-mail-or-username-for-a-data-breach> /help
check-e-mail-or-username-for-a-data-breach> /quit
```
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `data_breach_check`).
...
| Target | Result |
|--------|--------|
| `make build` | Native binary at `dist/<os>-<arch>/check-e-mail-or-username-for-a-data-breach-cli`. |
...
(`./check-e-mail-or-username-for-a-data-breach-cli <expr>`) and interactively (the REPL), and expressions compose the
