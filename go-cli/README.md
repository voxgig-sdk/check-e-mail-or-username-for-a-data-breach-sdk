...
AQL-driven CLI and REPL for the CheckEMailOrUsernameForADataBreach SDK. Positional arguments are
...
```sh
go build -o check-e-mail-or-username-for-a-data-breach-cli ./...
```
...
./check-e-mail-or-username-for-a-data-breach-cli load 1 data_breach_check
./check-e-mail-or-username-for-a-data-breach-cli load '{id:1}' data_breach_check
