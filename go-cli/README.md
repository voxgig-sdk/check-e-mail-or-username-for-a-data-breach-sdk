...
AQL-driven command-line client **and** interactive REPL for the CheckEMailOrUsernameForADataBreach
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `data_breach_check`).
