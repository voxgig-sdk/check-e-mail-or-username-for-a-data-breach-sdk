...
func registerSDKWords(r *eng.Registry, client *sdk.CheckEMailOrUsernameForADataBreachSDK) {
...
func runOp(client *sdk.CheckEMailOrUsernameForADataBreachSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
