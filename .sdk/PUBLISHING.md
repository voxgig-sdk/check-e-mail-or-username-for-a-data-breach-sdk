...
|---|---|---|
| `ts/` | @voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk \
      --repository voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk` shows it, and
`npm trust revoke @voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk --id=<id>` removes it.
