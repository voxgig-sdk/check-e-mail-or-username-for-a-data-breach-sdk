# CheckEMailOrUsernameForADataBreach SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # CheckEMailOrUsernameForADataBreachSDK.new, not CheckEMailOrUsernameForADataBreachSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    CheckEMailOrUsernameForADataBreachSDK.new(opts)
  end
