...
class StructUtilityTest < Minitest::Test
  def setup
    ...
    @runner       = CheckEMailOrUsernameForADataBreachOmni.make_runner(STRUCT_TEST_JSON_FILE, @client)
  ...
  def test_minor_stringify
    @runsetflags.call(@minor_spec["stringify"], {}, lambda { |vin|
      value = vin.key?("val") ? (vin["val"] == CheckEMailOrUsernameForADataBreachOmni::NULLMARK ? "null" : vin["val"]) : ""
