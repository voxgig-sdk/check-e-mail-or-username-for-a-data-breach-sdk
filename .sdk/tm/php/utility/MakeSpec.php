...
// CheckEMailOrUsernameForADataBreach SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class CheckEMailOrUsernameForADataBreachMakeSpec
{
    public static function call(CheckEMailOrUsernameForADataBreachContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = CheckEMailOrUsernameForADataBreachGraphql::CONTENT_TYPE;
        } else {
