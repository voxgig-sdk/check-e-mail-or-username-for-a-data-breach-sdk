...
// CheckEMailOrUsernameForADataBreach SDK utility: fetcher

class CheckEMailOrUsernameForADataBreachFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CheckEMailOrUsernameForADataBreachSDK/1.0)';
    ...
    public static function call(CheckEMailOrUsernameForADataBreachContext $ctx, string $fullurl, array $fetchdef): array
    {
