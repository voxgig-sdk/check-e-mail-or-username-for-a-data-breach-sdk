...
// CheckEMailOrUsernameForADataBreach SDK utility: graphql
//
...
class CheckEMailOrUsernameForADataBreachGraphql
{
    ...
    // equivalent.
    public static function body(CheckEMailOrUsernameForADataBreachContext $ctx): mixed
    {
    ...
    public static function errors(CheckEMailOrUsernameForADataBreachContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
