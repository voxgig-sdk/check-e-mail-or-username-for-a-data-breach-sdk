...
// CheckEMailOrUsernameForADataBreach SDK rbac feature
...
class CheckEMailOrUsernameForADataBreachRbacFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _required(CheckEMailOrUsernameForADataBreachContext $ctx): ?string
    {
    ...
    private function _reject(CheckEMailOrUsernameForADataBreachContext $ctx, string $required): void
    {
    ...
    private function _track(CheckEMailOrUsernameForADataBreachContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
