...
// CheckEMailOrUsernameForADataBreach SDK retry feature
...
class CheckEMailOrUsernameForADataBreachRetryFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    public function init(CheckEMailOrUsernameForADataBreachContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CheckEMailOrUsernameForADataBreachContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(CheckEMailOrUsernameForADataBreachContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(CheckEMailOrUsernameForADataBreachContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
