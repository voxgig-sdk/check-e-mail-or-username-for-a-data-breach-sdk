...
// CheckEMailOrUsernameForADataBreach SDK streaming feature
...
class CheckEMailOrUsernameForADataBreachStreamingFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _iterate(CheckEMailOrUsernameForADataBreachResult $result): \Generator
    {
    ...
    private function _streamable(CheckEMailOrUsernameForADataBreachContext $ctx): bool
    {
