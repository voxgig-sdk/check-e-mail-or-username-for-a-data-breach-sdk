...
// CheckEMailOrUsernameForADataBreach SDK clienttrack feature
...
class CheckEMailOrUsernameForADataBreachClienttrackFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    public function PostConstruct(CheckEMailOrUsernameForADataBreachContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CheckEMailOrUsernameForADataBreach-SDK';
