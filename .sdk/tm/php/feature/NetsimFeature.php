...
// CheckEMailOrUsernameForADataBreach SDK netsim feature
...
class CheckEMailOrUsernameForADataBreachNetsimFeature extends CheckEMailOrUsernameForADataBreachBaseFeature
{
    ...
    private function _simulate(CheckEMailOrUsernameForADataBreachContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CheckEMailOrUsernameForADataBreachContext $ctx, array $applied): void
    {
        $client = $this->client;
