...
// CheckEMailOrUsernameForADataBreach SDK feature test
//
...
class FtCtrl extends CheckEMailOrUsernameForADataBreachControl
{
...
class FtClient
{
    ...
    private CheckEMailOrUsernameForADataBreachUtility $utility;

    public function __construct(CheckEMailOrUsernameForADataBreachUtility $utility, array $options)
    {
    ...
    public function get_utility(): CheckEMailOrUsernameForADataBreachUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (CheckEMailOrUsernameForADataBreachContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public CheckEMailOrUsernameForADataBreachContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (CheckEMailOrUsernameForADataBreachContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = CheckEMailOrUsernameForADataBreachConfig::make_feature($name);
    ...
    private static function buildUrl(CheckEMailOrUsernameForADataBreachSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof CheckEMailOrUsernameForADataBreachError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new CheckEMailOrUsernameForADataBreachResponse($fetched);
        }
    ...
    private function fail(CheckEMailOrUsernameForADataBreachContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (CheckEMailOrUsernameForADataBreachContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
