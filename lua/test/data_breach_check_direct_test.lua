...
describe("DataBreachCheckDirect", function()
  it("should direct-list-data_breach_check", function()
    local setup = data_breach_check_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-data_breach_check", setup.live and "live" or "unit")
...
function data_breach_check_direct_setup(mockres)
