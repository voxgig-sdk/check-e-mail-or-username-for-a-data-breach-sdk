...
function runner.env_override(m)
  local live = runner.getenv("CHECKEMAILORUSERNAMEFORADATABREACH_TEST_LIVE")
  local override = runner.getenv("CHECKEMAILORUSERNAMEFORADATABREACH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHECKEMAILORUSERNAMEFORADATABREACH_TEST_EXPLAIN")
