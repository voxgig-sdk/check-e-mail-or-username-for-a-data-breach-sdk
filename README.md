...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/check-e-mail-or-username-for-a-data-breach` | `npm install @voxgig-sdk/check-e-mail-or-username-for-a-data-breach` |
| Python | `voxgig-sdk-check-e-mail-or-username-for-a-data-breach` | `pip install voxgig-sdk-check-e-mail-or-username-for-a-data-breach` |
| PHP | `voxgig-sdk/check-e-mail-or-username-for-a-data-breach` | `composer require voxgig-sdk/check-e-mail-or-username-for-a-data-breach` |
| Golang | `github.com/voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk/go` | `go get github.com/voxgig-sdk/check-e-mail-or-username-for-a-data-breach-sdk/go` |
| Ruby | `voxgig-sdk-check-e-mail-or-username-for-a-data-breach` | `gem install voxgig-sdk-check-e-mail-or-username-for-a-data-breach` |
| Lua | `voxgig-sdk-check-e-mail-or-username-for-a-data-breach` | `luarocks install voxgig-sdk-check-e-mail-or-username-for-a-data-breach` |
