...
type DataBreachCheckEntity struct {
	name    string
	client  *core.CheckEMailOrUsernameForADataBreachSDK
...
func NewDataBreachCheckEntity(client *core.CheckEMailOrUsernameForADataBreachSDK, entopts map[string]any) *DataBreachCheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataBreachCheckEntity) GetName() string { return e.name }
...
func (e *DataBreachCheckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataBreachCheckEntity) Deleted() bool {
	return e.deleted
}


func (e *DataBreachCheckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataBreachCheckEntity(e.client, opts)
}

func (e *DataBreachCheckEntity) Data(args ...any) any {
...
func (e *DataBreachCheckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DataBreachCheckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataBreachCheckEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DataBreachCheckEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataBreachCheckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataBreachCheckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataBreachCheckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
