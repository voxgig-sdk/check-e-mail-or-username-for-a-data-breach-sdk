...
// CheckEMailOrUsernameForADataBreach Go SDK: generated schemas. Do not edit.
//
...
func mustSpec(src string) map[string]any {
	...
	if err := json.Unmarshal([]byte(src), &out); err != nil {
		...
		panic("CheckEMailOrUsernameForADataBreach: embedded schema is not valid JSON: " + err.Error())
	}
	return out
}
