...
// instead of `sdk.NewCheckEMailOrUsernameForADataBreachSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CheckEMailOrUsernameForADataBreachSDK  { return NewCheckEMailOrUsernameForADataBreachSDK(nil) }
func Test() *CheckEMailOrUsernameForADataBreachSDK { return TestSDK(nil, nil) }
